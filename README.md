...
- SQL is the languange that relational databases use.

2. Why do tables need a Primary Key?

- To have a column uniquely track every record with the table.
...
- Say we have a books table and an authors table. The relationship between them can be many-to-many since one author can have many books and a books table can be filled with many authors.
